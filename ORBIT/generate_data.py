...
def gen_noise_data(noise_prob, rhos=[2.5, 3.5, 4.0, 4.1, 4.3], num_pts=1000, num_orbits_each=1000, grid_size=40, val_size=0.3, test_size=0.3):
    ...
    for p in noise_prob:
        ...
        X_tr_grid = pc2grid(X_tr_noise, grid_size)
        X_val_grid = pc2grid(X_val_noise, grid_size)
        X_test_grid = pc2grid(X_test_noise, grid_size)

        # apply DTM
        X_tr_dtm = dtm_transform(X_tr_noise, m0=0.02, lims=[[0.0125, 0.9875], [0.0125, 0.9875]], size=[grid_size, grid_size], weighted=False)
        X_val_dtm = dtm_transform(X_val_noise, m0=0.02, lims=[[0.0125, 0.9875], [0.0125, 0.9875]], size=[grid_size, grid_size], weighted=False)
        X_test_dtm = dtm_transform(X_test_noise, m0=0.02, lims=[[0.0125, 0.9875], [0.0125, 0.9875]], size=[grid_size, grid_size], weighted=False)
